#ifndef OCC_X86_TARGET_H
#define OCC_X86_TARGET_H

#include "target_backend.h"

class X86_TARGET final : public TARGET_BACKEND {
private:
  const TARGET_INFO &_info;

public:
  explicit X86_TARGET(const TARGET_INFO &info) : _info(info) {}
