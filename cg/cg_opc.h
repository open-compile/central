...
CGOPDEF( CGOPC_MOV   , 1,   1,  true,   CGOPR_R,  CGOPR_R,  CGOPR_N,   "mov"  , CGOPK_NONE  ) // Memory
CGOPDEF( CGOPC_MOVT  , 1,   1,  true,   CGOPR_R,  CGOPR_R,  CGOPR_N,   "movt" , CGOPK_NONE  ) // Memory
...
CGOPDEF( CGOPC_CMP   , 0,   2,  false,  CGOPR_N,  CGOPR_R,  CGOPR_R,   "cmp"  , CGOPK_NONE  )
CGOPDEF( CGOPC_BR    , 0,   1,  false,  CGOPR_IMM,CGOPR_N,  CGOPR_N,   "br"   , CGOPK_NONE  )
CGOPDEF( CGOPC_B     , 0,   1,  false,  CGOPR_N,  CGOPR_R,  CGOPR_N,   "b"    , CGOPK_NONE  ) // branch as well
CGOPDEF( CGOPC_BL    , 0,   1,  false,  CGOPR_N,  CGOPR_R,  CGOPR_N,   "bl"   , CGOPK_NONE  ) // branch indirect with label
...
CGOPDEF( CGOPC_BEQ   , 0,   1,  false,  CGOPR_R,  CGOPR_R,  CGOPR_R,   "beq"  , CGOPK_NONE  )
CGOPDEF( CGOPC_BNE   , 0,   1,  false,  CGOPR_R,  CGOPR_R,  CGOPR_R,   "bne"  , CGOPK_NONE  )
CGOPDEF( CGOPC_BGE   , 0,   1,  false,  CGOPR_R,  CGOPR_R,  CGOPR_R,   "bge"  , CGOPK_NONE  )
CGOPDEF( CGOPC_BLT   , 0,   1,  false,  CGOPR_R,  CGOPR_R,  CGOPR_R,   "blt"  , CGOPK_NONE  )
CGOPDEF( CGOPC_BGT   , 0,   1,  false,  CGOPR_R,  CGOPR_R,  CGOPR_R,   "bgt"  , CGOPK_NONE  )
CGOPDEF( CGOPC_BLE   , 0,   1,  false,  CGOPR_R,  CGOPR_R,  CGOPR_R,   "ble"  , CGOPK_NONE  )
...
CGOPDEF( CGOPC_DIV   , 1,   2,  true,   CGOPR_R,  CGOPR_R,  CGOPR_R,   "sdiv" , CGOPK_NONE  )
...
CGOPDEF( CGOPC_LIMM  , 1,   1,  true,   CGOPR_R,  CGOPR_IMM,CGOPR_N,   "limm" , CGOPK_NONE  )
CGOPDEF( CGOPC_LADDR , 1,   1,  true,   CGOPR_R,  CGOPR_R,  CGOPR_N,   "laddr", CGOPK_NONE  )
CGOPDEF( CGOPC_RET   , 0,   0,  false,  CGOPR_N,  CGOPR_N,  CGOPR_N,   "ret"  , CGOPK_NONE  )
CGOPDEF( CGOPC_ADJSP , 0,   1,  false,  CGOPR_IMM,CGOPR_N,  CGOPR_N,   "adjsp",CGOPK_NONE  )
