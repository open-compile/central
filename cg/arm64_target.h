#ifndef OCC_ARM64_TARGET_H
#define OCC_ARM64_TARGET_H

#include "target_backend.h"

class ARM64_TARGET final : public TARGET_BACKEND {
private:
  const TARGET_INFO &_info;

public:
  explicit ARM64_TARGET(const TARGET_INFO &info) : _info(info) {}
